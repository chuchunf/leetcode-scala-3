# Matrix
Matrix or grids are 2 or more dimensional arrays, similar to a one-dimensional array, but it can be visualised as a grid (or table) with rows and columns.

Matrix data structure is used to store data in table or grid. Each element in a matrix is identified by its row and column as a **cell**. 
<br><br>

## Basic operations
Generation, search, traversal etc.
### 54. Spiral Matrix 
